                ...
                <div class="p-6 text-gray-300 dark:text-gray-100">
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="title" name="title" class="w-full border border-gray-300 dark:border-gray-500 rounded-md py-2 px-3 text-black dark:text-gray-900 leading-tight focus:outline-none focus:border-red-500 dark:focus:border-red-500 focus:shadow-outline" placeholder="Enter the post title">
                            @error('title')
                        ...
                        <div class="mt-6">
                            <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
